...
SELECT Name FROM country WHERE name LIKE '%land%'; -- Includes 'land'
SELECT Name FROM country WHERE name LIKE 'land%'; -- Starts with 'land'
SELECT Name FROM country WHERE name LIKE '%land'; -- finish with 'land'
